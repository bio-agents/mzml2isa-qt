...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.agentButton_input_explore = QtWidgets.QAgentButton(self.centralwidget)
        self.agentButton_input_explore.setGeometry(QtCore.QRect(530, 162, 90, 25))
        self.agentButton_input_explore.setStyleSheet("font: 10pt url(:/fonts/assets/fonts/Verdana.ttf);")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("assets/graphics/browse_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.agentButton_input_explore.setIcon(icon1)
        self.agentButton_input_explore.setIconSize(QtCore.QSize(16, 16))
        self.agentButton_input_explore.setAgentButtonStyle(QtCore.Qt.AgentButtonTextOnly)
        self.agentButton_input_explore.setAutoRaise(False)
        self.agentButton_input_explore.setArrowType(QtCore.Qt.NoArrow)
        self.agentButton_input_explore.setObjectName("agentButton_input_explore")
        self.agentButton_output_explore = QtWidgets.QAgentButton(self.centralwidget)
        self.agentButton_output_explore.setEnabled(False)
        self.agentButton_output_explore.setGeometry(QtCore.QRect(530, 222, 90, 25))
        self.agentButton_output_explore.setStyleSheet("font: 10pt url(:/fonts/assets/fonts/Verdana.ttf);")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/graphics/assets/graphics/browse_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.agentButton_output_explore.setIcon(icon2)
        self.agentButton_output_explore.setIconSize(QtCore.QSize(16, 16))
        self.agentButton_output_explore.setAgentButtonStyle(QtCore.Qt.AgentButtonTextOnly)
        self.agentButton_output_explore.setObjectName("agentButton_output_explore")
        ...
        self.agentButton_help = QtWidgets.QAgentButton(self.centralwidget)
        self.agentButton_help.setGeometry(QtCore.QRect(330, 370, 90, 25))
        self.agentButton_help.setStyleSheet("font: 10pt url(:/fonts/assets/fonts/Verdana.ttf);")
        self.agentButton_help.setObjectName("agentButton_help")
...
"font: 24pt url(:/fonts/assets/fonts/HelveticaNeue.ttf);")
        ...
        self.agentButton_metadata = QtWidgets.QAgentButton(self.centralwidget)
        self.agentButton_metadata.setEnabled(True)
        self.agentButton_metadata.setGeometry(QtCore.QRect(430, 370, 90, 51))
        self.agentButton_metadata.setCheckable(False)
        self.agentButton_metadata.setAutoRepeatInterval(100)
        self.agentButton_metadata.setPopupMode(QtWidgets.QAgentButton.DelayedPopup)
        self.agentButton_metadata.setAutoRaise(False)
        self.agentButton_metadata.setObjectName("agentButton_metadata")
        self.agentButton_about = QtWidgets.QAgentButton(self.centralwidget)
        self.agentButton_about.setGeometry(QtCore.QRect(330, 395, 90, 25))
        self.agentButton_about.setStyleSheet("font: 10pt url(:/fonts/assets/fonts/Verdana.ttf);")
        self.agentButton_about.setObjectName("agentButton_about")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.agentButton_input_explore.setText(_translate("MainWindow", "Browse"))
        self.agentButton_output_explore.setText(_translate("MainWindow", "Browse"))
        ...
        self.agentButton_help.setText(_translate("MainWindow", "Help"))
        self.title.setText(_translate("MainWindow", "mzML to ISA-Tab "))
        self.agentButton_metadata.setText(_translate("MainWindow", "Add \n"
"Metadata"))
        self.agentButton_about.setText(_translate("MainWindow", "About"))
