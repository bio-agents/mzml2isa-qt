...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.ui.agentButton_input_explore.clicked.connect(self.exploreInput)
        self.ui.agentButton_output_explore.clicked.connect(self.exploreOutput)
        self.ui.agentButton_metadata.clicked.connect(self.getUserMeta)
        self.ui.agentButton_help.clicked.connect(self.openHelp)
    ...
    def toggleExport(self, int):
        ...
        if self.ui.cBox_export.isChecked():
            ...
            self.ui.agentButton_output_explore.setEnabled(False)
            ...
            self.ui.agentButton_output_explore.setEnabled(True)
